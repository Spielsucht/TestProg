...
namespace SpheroNET
{
    public class Sphero
    {
        ...
        {
            SendPacket(SpheroCommandPacketFactory.SetHeading(heading));
        }

        public void PerformMove(UInt16 heading, float speed)
        {
            SendPacket(SpheroCommandPacketFactory.Move(heading, speed));
        }

        public void SetBackLED(double intensivity)
        {
            SendPacket(SpheroCommandPacketFactory.SetBackLED(intensivity));
        }
    }
}
